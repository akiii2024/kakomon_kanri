      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text('ユーザーメール：${entry['userEmail']}', style: TextStyle(fontSize: 20)),
            SizedBox(height: 10),
            Text('学部：${entry['userDepartment']}', style: TextStyle(fontSize: 20)),
            SizedBox(height: 10),
            Text('学年：${entry['userGrade']}', style: TextStyle(fontSize: 20)),
          ],
        ),
      ),
    );
